# MySQL Server Down Script  
**RDS Manual Alerting (DOWN + UP Alerts)**  
This script monitors MySQL connectivity and sends HTML email alerts when the server is DOWN and a RESOLVED email when the server is UP again.
...
STATE_FILE="/path/mysql_server_state.txt"
